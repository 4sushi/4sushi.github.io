...
class Optimizer extends BackTesting{
  ...
  run(dir, callback){
    var tmpThis = this
    tmpThis.lines = []
    tmpThis.getFirstLineFile(dir, false, function(line){
      var firstTime = parseInt(line[0])
      tmpThis.loadFile(dir, function(){
        var resultats = tmpThis.optimize(firstTime)
        return callback(resultats[0]);
      });
    });
  }
