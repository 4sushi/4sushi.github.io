...
class BtOptimizeSlope extends Backtesting{
  ...
  optimize(){
    ...
    for(var iDicoSlopeAll in this.dicoSlopeAll){
      ...
      //resultatsAll = resultatsAll.concat(top10)
...
var main = function(){
  ...
  backTesting.run('/home/sushi/data/crypto/binance/sec/ETHBTC_3P', (resultats)=>{
